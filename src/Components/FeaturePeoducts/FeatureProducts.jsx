...
const FeatureProducts = () => {
    ...
    const featuredProducts=products.filter(product=>product.badge==="Hot");
    ...
    return (
        <div >
            <div className=" max-w-11/12 mx-auto mt-4">
             <h1 className="text-center pt-2 md:pt-4 text-2xl md:text-3xl font-bold">Featured products</h1>
             {success && (
